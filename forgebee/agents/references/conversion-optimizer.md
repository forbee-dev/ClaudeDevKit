# conversion-optimizer — Reference Material

Frameworks and templates referenced by `forgebee/agents/conversion-optimizer.md`. Moved here to keep the persona file under the 200-line budget (W16). The agent file holds discipline, Never rules, and self-review — this file holds the working library.
