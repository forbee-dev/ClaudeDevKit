...
Sections extracted from `forgebee/agents/phpunit-engineer.md` to keep the persona file under the 250-line budget. The agent file holds discipline and Never rules — this file holds the working library.
